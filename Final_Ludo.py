                {'x': 377, 'y': 456, 'c': 0, 'd': 0}, {'x': 377, 'y': 496, 'c': 0, 'd': 0},
                {'x': 377, 'y': 536, 'c': 0, 'd': 0}, {'x': 377, 'y': 576, 'c': 0, 'd': 0},
                {'x': 377, 'y': 614, 'c': 0, 'd': 0}, {'x': 337, 'y': 614, 'c': 0, 'd': 0},
                {'x': 337, 'y': 576, 'c': 0, 'd': 0}, {'x': 337, 'y': 536, 'c': 0, 'd': 0},
                {'x': 337, 'y': 496, 'c': 0, 'd': 0}, {'x': 337, 'y': 456, 'c': 0, 'd': 0},
                {'x': 337, 'y': 416, 'c': 0, 'd': 0}, {'x': 297, 'y': 614, 'c': 0, 'd': 0},
                {'x': 297, 'y': 576, 'c': 0, 'd': 0}, {'x': 297, 'y': 536, 'c': 0, 'd': 0},
                {'x': 297, 'y': 496, 'c': 0, 'd': 0}, {'x': 297, 'y': 456, 'c': 0, 'd': 0},
                {'x': 297, 'y': 416, 'c': 0, 'd': 0}, {'x': 256, 'y': 374, 'c': 0, 'd': 0},
                {'x': 216, 'y': 374, 'c': 0, 'd': 0}, {'x': 176, 'y': 374, 'c': 0, 'd': 0},
                {'x': 136, 'y': 374, 'c': 0, 'd': 0}, {'x': 96, 'y': 374, 'c': 0, 'd': 0},
                {'x': 56, 'y': 374, 'c': 0, 'd': 0}, {'x': 56, 'y': 334, 'c': 0, 'd': 0},
                {'x': 96, 'y': 334, 'c': 0, 'd': 0}, {'x': 136, 'y': 334, 'c': 0, 'd': 0},
                {'x': 176, 'y': 334, 'c': 0, 'd': 0}, {'x': 216, 'y': 334, 'c': 0, 'd': 0},
                {'x': 256, 'y': 334, 'c': 0, 'd': 0}, {'x': 56, 'y': 294, 'c': 0, 'd': 0}
                ]
...
def inHomeLane(my_player):
    l = []
    for i in range(4):
        if (my_player.ptokenlist[i].getlocation() != -2 and my_player.ptokenlist[i].getlocation() != -1 and
                    my_player.ptokenlist[i].color == Board[my_player.ptokenlist[i].getlocation()].color):
            l.append(i)
    return l
...
region_end ={'R':26,'Y':62,'G':44,'B':8}

def get_region(loc,my_token_color):
   if(my_token_color == 'R' and 0<=loc  and loc<=36):
       return True
   if (my_token_color == 'G' and 18<=loc  and loc<=54):
       return True
   if (my_token_color == 'Y' and ((36<=loc  and loc<=71) or loc ==0)):
       return True
   if (my_token_color == 'B' and ((54<=loc  and loc<=71) or (0<=loc  and loc<=18))):
       return True
   return False
...
def reach_safe_state(list1,dice):
    ...
    for i in list1:
        ...
        if((l !=-1 or l!=-2) and Board[l].home_lane_flag == False):
            ind=invalidHomeLane(i,dice)
            if(i.counter + dice <=57 and(Board[ind].home_lane_flag == True or Board[ind].safe_state_flag == True)):#if token will go inside home lane with added dice value or finish
                #if(Board[ind].safe_state_flag == True ): #1st priority is given if token can move safe state
                return i
    return None
...
def aggresive_move2(list2, dice_value):
    ...
    for i in list2:
        ...
        my_loc = i.getlocation()
        if (my_loc == -2 or my_loc == -1 or Board[my_loc].safe_state_flag == True):
            continue
        for j in range(4):
            count = 0
            correct_ind = invalidHomeLane(i,dice_value)  # returns the correct index of mytoken if required
...
def aggresive_move(list1, dice_value):
    ...
    for i in list1:
        ...
        for j in range(4):
            correct_ind = invalidHomeLane(i,dice_value)  # returns the correct index of mytoken if required
            # checks if the other's token is not in safe state
            if ((Board[correct_ind].safe_state_flag == False) and (
                correct_ind == opp_player.ptokenlist[j].getlocation())): #chasing other player within 3 cells of new loc
                if valid_move(i, dice_value):
                    return i
    return None
...
def getFastMovePiece(list1, dice_value):
    ...
    for i in list1:
        ...
        if(i.counter >51):
            continue
        if (i.counter + dice_value > 57):
            continue
        if (l != -1 and l != -2 and (i.color != Board[i.getlocation()].color)):  # do this only if the piece is out or not and not in home lane
            if valid_move(i, dice_value):
                diff = (startHomeLane[i.color] - l) % 72
                if (diff < min_diff):
                    min_diff = diff
                    pc = i
    return pc
...
def getBestPossibleMove(my_player, opp_player, dice_value):
    ...
    pc=None
    for i in range(4):
        loc=my_player.ptokenlist[i].getlocation()
        if(get_region(loc,my_player.color)):
            list_1.append(my_player.ptokenlist[i])
        else:
            list_2.append(my_player.ptokenlist[i])
    if(len(list_2)!= 0):
        pc = reach_safe_state(list_2,dice_value)

        if(pc == None):
            pc =defensive_move(list_2, dice_value)

        elif(pc ==None):
            pc=aggresive_move2(list_2,dice_value)


    # for list 1
    if(pc == None and len(list_1)):
        pc = aggresive_move(list_1, dice_value)

        if (pc == None):
            pc = defensive_move(list_1, dice_value)

        elif (pc == None):
            pc = reach_safe_state(list_1, dice_value)

    if(len(list_1)==0 or dice_value>5):
        if(pc == None and len(list_2)!= 0):
            pc = getFastMovePiece(list_2, dice_value)

        if (pc == None and len(list_1) != 0):
            pc = getFastMovePiece(list_1, dice_value)
    else:
        if (pc == None and len(list_1) != 0):
            pc = getFastMovePiece(list_1, dice_value)
    ...
    while alive:
        ...
        while (not my_player.haswon()) and (not opp_player.haswon()):
            ...
            if REPEAT == False:
                ...
                REPEAT = False
            if (my_player.win_pieces == 4 or opp_player.win_pieces == 4):
                sys.exit(0)
            dice = sys.stdin.readline().strip()
            i = 3
            opp_value_list = []
